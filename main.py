...
#7 25min work
#8 20min break
# after 4 sets of 25 take a long break
#use the reps to count down the appropriate no of seconds
...
#display image
canvas = Canvas(width=200, height=224, bg=YELLOW, highlightthicknes=1)
